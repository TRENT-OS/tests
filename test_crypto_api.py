...
OS_Crypto_MODE_CLIENT     = 2
OS_Crypto_MODE_KEY_SWITCH = 3
...
def test_OS_CryptoAgreement_init_pos_0(boot):
    ...
    this function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoAgreement_init_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoAgreement_init_neg_0(boot):
    ...
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoAgreement_init_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoAgreement_agree_neg_0(boot):
    ...
    crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoAgreement_agree_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoAgreement_free_pos_0(boot):
    ...
    this function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoAgreement_free_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoAgreement_do_DH_0(boot):
    ...
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoAgreement_do_DH', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)

def test_OS_CryptoAgreement_do_ECDH_0(boot):
    """
    Compute shared key for randomly generated public/private keys with ECDH.
    """
    parser.check_test(boot(TEST_NAME), 10, 'test_OS_CryptoAgreement_do_ECDH', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoAgreement_do_DH_rnd_0(boot):
    ...
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoAgreement_do_DH_rnd', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoAgreement_do_ECDH_rnd_0(boot):
    ...
    """
    parser.check_test(boot(TEST_NAME), 60, 'test_OS_CryptoAgreement_do_ECDH_rnd', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoCipher_init_pos_0(boot):
    ...
    this function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_init_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoCipher_init_neg_0(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_init_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoCipher_free_pos_0(boot):
    ...
    function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_free_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoCipher_free_neg_0(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_free_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoCipher_start_neg_0(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_start_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoCipher_process_neg_0(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_process_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoCipher_do_AES_ECB_enc_0(boot):
    ...
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_do_AES_ECB_enc', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)

def test_OS_CryptoCipher_do_AES_ECB_dec_0(boot):
    """
    Decrypt a set of ciphertext vectors with AES-ECB.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_do_AES_ECB_dec', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)

def test_OS_CryptoCipher_do_AES_CBC_enc_0(boot):
    """
    Encrypt a set of plaintext vectors with AES-CBC.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_do_AES_CBC_enc', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoCipher_do_AES_GCM_enc_0(boot):
    ...
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_do_AES_GCM_enc', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)

def test_OS_CryptoCipher_do_AES_GCM_dec_pos_0(boot):
    """
    Decrypt a set of ciphertext vectors with AES-GCM.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_do_AES_GCM_dec_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)

def test_OS_CryptoCipher_do_AES_GCM_dec_neg_0(boot):
    """
    Encrypt a ciphertext with AES-GCM but modify the tag so it is invalid.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_do_AES_GCM_dec_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoCipher_do_AES_ECB_rnd_0(boot):
    ...
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_do_AES_ECB_rnd', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoDigest_init_pos_0(boot):
    ...
    function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoDigest_init_pos', 'mode=%i' % OS_Crypto_MODE_LIBRARY)

def test_OS_CryptoDigest_init_neg_0(boot):
    """
    Negative tests for OS_CryptoDigest_init(), covering the invalid ways of using
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoDigest_init_neg', 'mode=%i' % OS_Crypto_MODE_LIBRARY)

def test_OS_CryptoDigest_free_pos_0(boot):
    """
    Positive tests for OS_CryptoDigest_free(), covering the valid ways of using this
    function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoDigest_free_pos', 'mode=%i' % OS_Crypto_MODE_LIBRARY)

def test_OS_CryptoDigest_free_neg_0(boot):
    """
    Negative tests for OS_CryptoDigest_free(), covering the invalid ways of using
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoDigest_free_neg', 'mode=%i' % OS_Crypto_MODE_LIBRARY)

def test_OS_CryptoDigest_clone_pos_0(boot):
    """
    Positive tests for OS_CryptoDigest_clone(), covering the valid ways of using
    this function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoDigest_clone_pos', 'mode=%i' % OS_Crypto_MODE_LIBRARY)

def test_OS_CryptoDigest_clone_neg_0(boot):
    """
    Negative tests for OS_CryptoDigest_clone(), covering the invalid ways of using
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoDigest_clone_neg', 'mode=%i' % OS_Crypto_MODE_LIBRARY)

def test_OS_CryptoDigest_process_neg_0(boot):
    """
    Negative tests for OS_CryptoDigest_process(), covering the invalid ways of using
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoDigest_process_neg', 'mode=%i' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoDigest_do_SHA256_0(boot):
    ...
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoDigest_do_SHA256', 'mode=%i' % OS_Crypto_MODE_LIBRARY)

def test_OS_CryptoDigest_do_MD5_0(boot):
    """
    Hash some testvectors with MD5.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoDigest_do_MD5', 'mode=%i' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoKey_import_pos_0(boot):
    ...
    this function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoKey_import_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoKey_import_neg_0(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoKey_import_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoKey_makePublic_pos_0(boot):
    ...
    this function.
    """
    parser.check_test(boot(TEST_NAME), 20, 'test_OS_CryptoKey_makePublic_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoKey_makePublic_neg_0(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoKey_makePublic_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoKey_getParams_pos_0(boot):
    ...
    this function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoKey_getParams_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoKey_getParams_neg_0(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoKey_getParams_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoKey_loadParams_pos_0(boot):
    ...
    this function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoKey_loadParams_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoKey_loadParams_neg_0(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoKey_loadParams_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoKey_getAttribs_pos_0(boot):
    ...
    this function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoKey_getAttribs_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoKey_getAttribs_neg_0(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoKey_getAttribs_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoKey_free_pos_0(boot):
    ...
    function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoKey_free_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoMac_init_pos_0(boot):
    ...
    function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoMac_init_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoMac_init_neg_0(boot):
    ...
    function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoMac_init_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoMac_free_pos_0(boot):
    ...
    function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoMac_free_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoMac_free_neg_0(boot):
    ...
    function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoMac_free_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoMac_process_neg_0(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoMac_process_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoMac_do_HMAC_MD5_0(boot):
    ...
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoMac_do_HMAC_MD5', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)

def test_OS_CryptoMac_do_HMAC_SHA256_0(boot):
    """
    Compute MAC on testvectors with HMAC-SHA256.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoMac_do_HMAC_SHA256', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)

def test_OS_CryptoRng_getBytes_pos_0(boot):
    """
    Positive tests for OS_CryptoRng_getBytes(), covering the valid ways of using
    this function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoRng_getBytes_pos', 'mode=%i' % OS_Crypto_MODE_LIBRARY)

def test_OS_CryptoRng_getBytes_neg_0(boot):
    """
    Negative tests for OS_CryptoRng_getBytes(), covering the invalid ways of using
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoRng_getBytes_neg', 'mode=%i' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoRng_reSeed_pos_0(boot):
    ...
    this function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoRng_reSeed_pos', 'mode=%i' % OS_Crypto_MODE_LIBRARY)

def test_OS_CryptoRng_reSeed_neg_0(boot):
    """
    Negative tests for OS_CryptoRng_reSeed(), covering the invalid ways of using
    this function thus verifying that it returns error codes instead of crashing.
    """
...
def test_OS_CryptoSignature_init_pos_0(boot):
    ...
    this function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoSignature_init_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoSignature_init_neg_0(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoSignature_init_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoSignature_free_pos_0(boot):
    ...
    this function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoSignature_free_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoSignature_free_neg_0(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoSignature_free_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoSignature_sign_neg_0(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoSignature_sign_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)

def test_OS_CryptoSignature_verify_neg_0(boot):
    """
    Negative tests for OS_CryptoSignature_verify(), covering the invalid ways of
    using this function thus verifying that it returns error codes instead of
    crashing.
    """
...
def test_OS_CryptoSignature_do_RSA_PKCS1_V15_sign_0(boot):
    ...
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoSignature_do_RSA_PKCS1_V15_sign', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)

def test_OS_CryptoSignature_do_RSA_PKCS1_V15_verify_0(boot):
    """
    Verify some testvectors with RSA PCKS#1 V1.5.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoSignature_do_RSA_PKCS1_V15_verify', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)

def test_OS_CryptoSignature_do_RSA_PKCS1_V21_verify_0(boot):
    """
    Verify some testvectors with RSA PCKS#1 V2.1.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoSignature_do_RSA_PKCS1_V21_verify', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoSignature_do_RSA_PKCS1_V15_rnd_0(boot):
    ...
    """
    parser.check_test(boot(TEST_NAME), 20, 'test_OS_CryptoSignature_do_RSA_PKCS1_V15_rnd', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_LIBRARY)
...
def test_OS_CryptoRng_reSeed_pos_1(boot):
    """
    Positive tests for OS_CryptoRng_reSeed(), covering the valid ways of using this
    function.
    """
...
def test_OS_CryptoAgreement_init_pos_2(boot):
    ...
    this function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoAgreement_init_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoAgreement_init_neg_2(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoAgreement_init_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoAgreement_agree_neg_2(boot):
    ...
    crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoAgreement_agree_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoAgreement_free_pos_2(boot):
    ...
    this function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoAgreement_free_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoAgreement_do_DH_2(boot):
    ...
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoAgreement_do_DH', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)

def test_OS_CryptoAgreement_do_ECDH_2(boot):
    """
    Execute key agreement based on testvector using ECDH algorithm.
    """
    parser.check_test(boot(TEST_NAME), 10, 'test_OS_CryptoAgreement_do_ECDH', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoAgreement_do_DH_rnd_2(boot):
    ...
    pair with the DH algorithm. Check that the results match. Iterate for a few times (~5).
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoAgreement_do_DH_rnd', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoAgreement_do_ECDH_rnd_2(boot):
    ...
    pair with the ECDH algorithm. Check that the results match. Iterate for a few times (~5).
    """
    parser.check_test(boot(TEST_NAME), 60, 'test_OS_CryptoAgreement_do_ECDH_rnd', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)

def test_OS_CryptoAgreement_do_DH_3(boot):
    """
    Execute key agreement based on testvector using DH algorithm.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoAgreement_do_DH', 'mode=%i,keepLocal=0' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoAgreement_do_DH_rnd_3(boot):
    ...
    pair with the DH algorithm. Check that the results match. Iterate for a few times (~5).
    """
    parser.check_test(boot(TEST_NAME), 2, 'test_OS_CryptoAgreement_do_DH_rnd', 'mode=%i,keepLocal=0' % OS_Crypto_MODE_KEY_SWITCH)

def test_OS_CryptoAgreement_do_ECDH_3(boot):
    """
    Execute key agreement based on testvector using ECDH algorithm.
    """
    parser.check_test(boot(TEST_NAME), 10, 'test_OS_CryptoAgreement_do_ECDH', 'mode=%i,keepLocal=0' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoAgreement_do_ECDH_rnd_3(boot):
    ...
    pair with the ECDH algorithm. Check that the results match. Iterate for a few times (~5).
    """
    parser.check_test(boot(TEST_NAME), 60, 'test_OS_CryptoAgreement_do_ECDH_rnd', 'mode=%i,keepLocal=0' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoAgreement_key_neg_0(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoAgreement_key_neg', 'mode=%i,keepLocal=0' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoCipher_init_pos_2(boot):
    ...
    function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_init_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoCipher_init_neg_2(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_init_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoCipher_free_pos_2(boot):
    ...
    function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_free_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoCipher_free_neg_2(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_free_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoCipher_start_neg_2(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_start_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoCipher_process_neg_2(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_process_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoCipher_do_AES_ECB_enc_2(boot):
    ...
    Encrypt a set of plaintext vectors with AES-ECB.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_do_AES_ECB_enc', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)

def test_OS_CryptoCipher_do_AES_ECB_dec_2(boot):
    """
    Decrypt a set of ciphertext vectors with AES-ECB.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_do_AES_ECB_dec', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)

def test_OS_CryptoCipher_do_AES_CBC_enc_2(boot):
    """
    Encrypt a set of plaintext vectors with AES-CBC.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_do_AES_CBC_enc', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoCipher_do_AES_GCM_enc_2(boot):
    ...
    Encrypt a set of plaintext vectors with AES-GCM.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_do_AES_GCM_enc', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)

def test_OS_CryptoCipher_do_AES_GCM_dec_pos_2(boot):
    """
    Encrypt a set of ciphertext vectors with AES-GCM.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_do_AES_GCM_dec_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)

def test_OS_CryptoCipher_do_AES_GCM_dec_neg_2(boot):
    """
    Encrypt a ciphertext with AES-GCM but modify the tag so it is invalid.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_do_AES_GCM_dec_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoCipher_do_AES_ECB_rnd_2(boot):
    ...
    Check that inputs and outputs match. Repeat for a few (~1000) iterations.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_do_AES_ECB_rnd', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoCipher_do_AES_GCM_rnd_2(boot):
    ...
    Check that inputs and outputs match. Repeat for a few (~1000) iterations.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_do_AES_GCM_rnd', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)

def test_OS_CryptoCipher_do_AES_ECB_enc_3(boot):
    """
    Encrypt a set of plaintext vectors with AES-ECB.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_do_AES_ECB_enc', 'mode=%i,keepLocal=0' % OS_Crypto_MODE_KEY_SWITCH)

def test_OS_CryptoCipher_do_AES_ECB_dec_3(boot):
    """
    Decrypt a set of ciphertext vectors with AES-ECB.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_do_AES_ECB_dec', 'mode=%i,keepLocal=0' % OS_Crypto_MODE_KEY_SWITCH)

def test_OS_CryptoCipher_do_AES_CBC_enc_3(boot):
    """
    Encrypt a set of plaintext vectors with AES-CBC.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_do_AES_CBC_enc', 'mode=%i,keepLocal=0' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoCipher_do_AES_GCM_enc_3(boot):
    ...
    Encrypt a set of plaintext vectors with AES-GCM.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_do_AES_GCM_enc', 'mode=%i,keepLocal=0' % OS_Crypto_MODE_KEY_SWITCH)

def test_OS_CryptoCipher_do_AES_GCM_dec_pos_3(boot):
    """
    Decrypt a set of ciphertext vectors with AES-GCM.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_do_AES_GCM_dec_pos', 'mode=%i,keepLocal=0' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoCipher_do_AES_ECB_rnd_3(boot):
    ...
    Check that inputs and outputs match. Repeat for a few (~1000) iterations.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_do_AES_ECB_rnd', 'mode=%i,keepLocal=0' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoCipher_do_AES_GCM_rnd_3(boot):
    ...
    Check that inputs and outputs match. Repeat for a few (~1000) iterations.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoCipher_do_AES_GCM_rnd', 'mode=%i,keepLocal=0' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoDigest_init_pos_2(boot):
    ...
    function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoDigest_init_pos', 'mode=%i' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoDigest_init_neg_2(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoDigest_init_neg', 'mode=%i' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoDigest_free_pos_2(boot):
    ...
    function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoDigest_free_pos', 'mode=%i' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoDigest_free_neg_2(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoDigest_free_neg', 'mode=%i' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoDigest_clone_pos_2(boot):
    ...
    this function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoDigest_clone_pos', 'mode=%i' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoDigest_clone_neg_2(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoDigest_clone_neg', 'mode=%i' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoDigest_process_neg_2(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoDigest_process_neg', 'mode=%i' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoDigest_do_SHA256_2(boot):
    ...
    Hash some testvectors with SHA256.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoDigest_do_SHA256', 'mode=%i' % OS_Crypto_MODE_KEY_SWITCH)

def test_OS_CryptoDigest_do_MD5_2(boot):
    """
    Hash some testvectors with MD5.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoDigest_do_MD5', 'mode=%i' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoKey_import_pos_2(boot):
    ...
    function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoKey_import_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoKey_import_neg_2(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoKey_import_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoKey_export_pos_2(boot):
    ...
    function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoKey_export_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoKey_export_neg_2(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoKey_export_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoKey_generate_pos_2(boot):
    ...
    this function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoKey_generate_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoKey_generate_neg_2(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoKey_generate_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoKey_makePublic_pos_2(boot):
    ...
    this function.
    """
    parser.check_test(boot(TEST_NAME), 20, 'test_OS_CryptoKey_makePublic_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoKey_makePublic_neg_2(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoKey_makePublic_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoKey_getParams_pos_2(boot):
    ...
    this function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoKey_getParams_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoKey_getParams_neg_2(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoKey_getParams_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoKey_loadParams_pos_2(boot):
    ...
    this function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoKey_loadParams_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoKey_loadParams_neg_2(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoKey_loadParams_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoKey_getAttribs_pos_2(boot):
    ...
    this function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoKey_getAttribs_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoKey_getAttribs_neg_2(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoKey_getAttribs_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoKey_free_pos_2(boot):
    ...
    function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoKey_free_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoKey_import_pos_3(boot):
    ...
    function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoKey_import_pos', 'mode=%i,keepLocal=0' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoKey_makePublic_pos_3(boot):
    ...
    this function.
    """
    parser.check_test(boot(TEST_NAME), 20, 'test_OS_CryptoKey_makePublic_pos', 'mode=%i,keepLocal=0' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoKey_getParams_pos_3(boot):
    ...
    this function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoKey_getParams_pos', 'mode=%i,keepLocal=0' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoKey_loadParams_pos_3(boot):
    ...
    this function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoKey_loadParams_pos', 'mode=%i,keepLocal=0' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoMac_init_pos_2(boot):
    ...
    function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoMac_init_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoMac_init_neg_2(boot):
    ...
    function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoMac_init_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoMac_free_pos_2(boot):
    ...
    function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoMac_free_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoMac_free_neg_2(boot):
    ...
    function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoMac_free_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoMac_process_neg_2(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoMac_process_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoMac_do_HMAC_MD5_2(boot):
    ...
    Compute MAC on testvectors with HMAC-MD5.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoMac_do_HMAC_MD5', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)

def test_OS_CryptoMac_do_HMAC_SHA256_2(boot):
    """
    Compute MAC on testvectors with HMAC-SHA256.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoMac_do_HMAC_SHA256', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)

def test_OS_CryptoMac_do_HMAC_MD5_3(boot):
    """
    Compute MAC on testvectors with HMAC-MD5.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoMac_do_HMAC_MD5', 'mode=%i,keepLocal=0' % OS_Crypto_MODE_KEY_SWITCH)

def test_OS_CryptoMac_do_HMAC_SHA256_3(boot):
    """
    Compute MAC on testvectors with HMAC-SHA256.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoMac_do_HMAC_SHA256', 'mode=%i,keepLocal=0' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoRng_getBytes_pos_2(boot):
    ...
    this function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoRng_getBytes_pos', 'mode=%i' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoRng_getBytes_neg_2(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoRng_getBytes_neg', 'mode=%i' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoRng_reSeed_pos_2(boot):
    ...
    function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoRng_reSeed_pos', 'mode=%i' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoSignature_init_pos_2(boot):
    ...
    this function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoSignature_init_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoSignature_init_neg_2(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoSignature_init_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoSignature_free_pos_2(boot):
    ...
    this function.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoSignature_free_pos', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoSignature_free_neg_2(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoSignature_free_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoSignature_sign_neg_2(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoSignature_sign_neg', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoSignature_do_RSA_PKCS1_V15_sign_2(boot):
    ...
    Sign some testvectors with RSA PCKS#1 V1.5.
    """
    parser.check_test(boot(TEST_NAME), 2, 'test_OS_CryptoSignature_do_RSA_PKCS1_V15_sign', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)

def test_OS_CryptoSignature_do_RSA_PKCS1_V15_verify_2(boot):
    """
    Verify some testvectors with RSA PCKS#1 V1.5.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoSignature_do_RSA_PKCS1_V15_verify', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)

def test_OS_CryptoSignature_do_RSA_PKCS1_V21_verify_2(boot):
    """
    Verify some testvectors with RSA PCKS#1 V2.1.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoSignature_do_RSA_PKCS1_V21_verify', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoSignature_do_RSA_PKCS1_V15_rnd_2(boot):
    ...
    Repeat for a few iterations (~10).
    """
    parser.check_test(boot(TEST_NAME), 20, 'test_OS_CryptoSignature_do_RSA_PKCS1_V15_rnd', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoSignature_do_RSA_PKCS1_V21_rnd_2(boot):
    ...
    Repeat for a few iterations (~10).
    """
    parser.check_test(boot(TEST_NAME), 30, 'test_OS_CryptoSignature_do_RSA_PKCS1_V21_rnd', 'mode=%i,keepLocal=1' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoSignature_do_RSA_PKCS1_V15_verify_3(boot):
    ...
    Verify some testvectors with RSA PCKS#1 V1.5.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoSignature_do_RSA_PKCS1_V15_verify', 'mode=%i,keepLocal=0' % OS_Crypto_MODE_KEY_SWITCH)

def test_OS_CryptoSignature_do_RSA_PKCS1_V21_verify_3(boot):
    """
    Verify some testvectors with RSA PCKS#1 V2.1.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoSignature_do_RSA_PKCS1_V21_verify', 'mode=%i,keepLocal=0' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoSignature_do_RSA_PKCS1_V15_rnd_3(boot):
    ...
    Repeat for a few iterations (~10).
    """
    parser.check_test(boot(TEST_NAME), 20, 'test_OS_CryptoSignature_do_RSA_PKCS1_V15_rnd', 'mode=%i,keepLocal=0' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoSignature_do_RSA_PKCS1_V21_rnd_3(boot):
    ...
    Repeat for a few iterations (~10).
    """
    parser.check_test(boot(TEST_NAME), 30, 'test_OS_CryptoSignature_do_RSA_PKCS1_V21_rnd', 'mode=%i,keepLocal=0' % OS_Crypto_MODE_KEY_SWITCH)
...
def test_OS_CryptoSignature_key_neg_0(boot):
    ...
    this function thus verifying that it returns error codes instead of crashing.
    """
    parser.check_test(boot(TEST_NAME), 1, 'test_OS_CryptoSignature_key_neg', 'mode=%i,keepLocal=0' % OS_Crypto_MODE_KEY_SWITCH)

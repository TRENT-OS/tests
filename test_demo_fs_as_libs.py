...
def test_run_demo(boot_with_proxy):
    """ This demo utilizes both the partition manager and the filesystem as lib
    and makes use of all relevant TRENTOS-M Filesystem API functions. """
    ...
    with  open(proxy_memory_file,"wb") as f:
        ...
        # are defined in the define TRENTOS-M system config file. One day we
        # should extend things, so the TRENTOS-M system can request the proxy to
        ...
        # here with the TRENTOS-M system manually.

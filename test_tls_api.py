...
def test_OS_Tls_handshake_neg_1(boot_with_proxy, tls_server):
    ...
    this function thus verifying that it returns error codes instead of crashing
    """
    parser.check_test(boot_with_proxy(TEST_NAME), 5, 'test_OS_Tls_handshake_neg', 'mode=%i' % OS_Tls_MODE_CLIENT)
...
def test_OS_Tls_write_neg_1(boot_with_proxy, tls_server):
    ...
    function thus verifying that it returns error codes instead of crashing
    """
    parser.check_test(boot_with_proxy(TEST_NAME), 5, 'test_OS_Tls_write_neg', 'mode=%i' % OS_Tls_MODE_CLIENT)
...
def test_OS_Tls_write_pos_1(boot_with_proxy, tls_server):
    ...
    function.
    """
    parser.check_test(boot_with_proxy(TEST_NAME), 5, 'test_OS_Tls_write_pos', 'mode=%i' % OS_Tls_MODE_CLIENT)
...
def test_OS_Tls_read_neg_1(boot_with_proxy, tls_server):
    ...
    function thus verifying that it returns error codes instead of crashing
    """
    parser.check_test(boot_with_proxy(TEST_NAME), 5, 'test_OS_Tls_read_neg', 'mode=%i' % OS_Tls_MODE_CLIENT)
...
def test_OS_Tls_read_pos_1(boot_with_proxy, tls_server):
    ...
    function.
    """
    parser.check_test(boot_with_proxy(TEST_NAME), 5, 'test_OS_Tls_read_pos', 'mode=%i' % OS_Tls_MODE_CLIENT)
...
def test_OS_Tls_reset_neg_1(boot_with_proxy, tls_server):
    ...
    function thus verifying that it returns error codes instead of crashing
    """
    parser.check_test(boot_with_proxy(TEST_NAME), 5, 'test_OS_Tls_reset_neg', 'mode=%i' % OS_Tls_MODE_CLIENT)
